...
<a href="https://mail.google.com/mail/?view=cm&fs=1&to=vijirohith64@gmail.com" target="_blank">
...
Focus:     Web Security, APIs, Cloud, Full-Stack Dev
Status:    Building secure, practical software.
Currently: Exploring web security, APIs, cloud
           and modern full-stack development.
```
```bash
rohith@dev:~$ neofetch --skills
```
```yaml
...
Security:     Web App Security · API Security · Network Security
              OWASP · Linux · Burp Suite · Wireshark
...
<p align="center"><i>"Building secure, practical software while exploring cybersecurity, web security, APIs, and modern full-stack development."</i></p>
